                ...
                <div class="mx-4 sm:p-8">
                    ...
                    <form method="post" action="{{ route('post.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="mt-8 my-10 flex">
                            ...
                            <p class="text-spons_blue font-bold hover:underline decoration-solid"><a
                                    href="{{ route('user.show', $user) }}">{{ $user->name }}</a></p>
                        </div>
                        ...
                        <div class="mb-10 flex">
                            ...
                            <select class="sp_select w-1/4 bg-gray-200 rounded" name="category_id">
                        ...
                        <div class="mb-10 flex">
                            ...
                            <select class="sp_select w-1/4 bg-gray-200 rounded" name="post_type_id">
                        ...
                        <div class="mb-10 flex">
                            ...
                            <select class="sp_select w-1/4 bg-gray-200 rounded" name="prefecture_id">
            ...
            <div class="mx-auto px-4 sm:px-6 lg:px-8" style="max-width: 1100px;">
                <div class="mx-4 sm:p-8">
                    ...
                    <form method="post" action="{{ route('post.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="mb-12">
                            <p class="mr-8 font-bold mb-2">画像（1MBまで）</p>
                            <div>
                                <input type="file" name="image">
                            </div>
                        </div>
