                    ...
                    <div class="mb-10 flex">
                        ...
                        <select class="w-1/4 bg-gray-200 rounded" name="post_type_id">
                            @foreach ($post_types as $post_type)
                                <option value="{{ $post_type->id }}" @if ($post_type->id === $post->post_type_id) selected @endif>
                    ...
                    <div class="mb-10 flex">
                        ...
                        <select class="w-1/4 bg-gray-200 rounded" name="prefecture_id">
                            @foreach ($prefectures as $prefecture)
                                <option value="{{ $prefecture->id }}" @if ($prefecture->id === $post->prefecture_id) selected @endif>
