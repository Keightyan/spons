    ...
    <div class="categories">
        <ul class="flex">
            @foreach ($categories as $category)
                <li><a
                        href="/posts/search?category_id={{ $category->id }}&post_type_id=all_post_types&prefecture_id=all_prefectures&search=検索"><img
                            src="{{ asset("/img/{$category->image}") }}" class="pictogram">{{ $category->name }}</a>
                </li>
            @endforeach
